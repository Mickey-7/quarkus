...
import org.acme.service.BannedUserService;
...
//        return Response.created(userUri).build();
        ...
        //modified to cater banning of use
        if (bannedUserService.isBanned(userModel.username)){
